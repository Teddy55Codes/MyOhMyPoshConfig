...
![preview of all segements which are always visible](./resources/min.svg)

### with all included segments
![preview with all segements](./resources/max.svg)


## Notable Features

![preview with anotations](./resources/features.png)
